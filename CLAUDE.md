...
- No border-radius anywhere (grep for `rounded`, `border-radius`)
- No box-shadow except the single sheet-elevation token
- No font-weight above 500
- No serif, no italic display type
- No fade-in, fade-up, scale, or scroll-triggered animation
- No new icon imports
- Colours come from tokens only — no hex literals in components
