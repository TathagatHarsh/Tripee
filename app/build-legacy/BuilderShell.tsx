...
import { Docket } from "@/components/docket-legacy/Docket";
import { PhaseMeters, StepFooter, StepNav, useStepPosition } from "@/components/builder-legacy/StepNav";
import { ToppingBar } from "@/components/builder-legacy/ToppingBar";
import { UndoBar } from "@/components/builder-legacy/UndoBar";
  ...
  return (
    <header className="flex h-15 shrink-0 items-center justify-between gap-4 border-b border-rule bg-paper px-4 lg:px-6">
      <div className="flex min-w-0 items-center gap-3.5">
        ...
        {/* Which of the two builders you are looking at. The whole point of
            keeping this copy is comparison, and two identical shells are not
            comparable. A boxed label rather than a stamp: --stamp is rationed to
            four uses in the journey and an archived route is not worth one. */}
        <span className="shrink-0 border border-carbon px-1.5 py-0.5 font-mono text-micro tracking-[0.14em] text-carbon">
          PREVIOUS DESIGN
        </span>
        {reference && (
          <>
